...
def monte_carlo(start_price, days, mu, sigma, prev_days, dt):
...
#     start_price = data['Adj Close'].iloc[
#         0]  # retrieves the adjusted closing prices of all the stocks in your datase
...
#TODO: Later is commented as of now
...
def stockAnalysis(start_date, end_date, stock_symbol, num_simulations):
    print('hello')
